...
guanwang = "http://info.xingtai.gov.cn/highSearch.jsp?pn="
guanwang2 = "&keywords=%25E8%25A7%2584%25E5%2588%2592&pid=&keywords=%25E8%25A7%2584%25E5%2588%2592&fieldSt=2&classId=&pid=&classId=&pid=&classId=&pid=&classId=&pid=&classId=&pid=&classId="

# # 文章的链接
# xpathURL =   ""

# a标签
xpath_a = "/html/body/div[2]/div/div[2]/div[1]/ul/*/a"

# a的文本
xpath_a_text = "/html/body/div[2]/div/div[2]/div[1]/ul/*/a"

# 时间
xpath_time = "/html/body/div[2]/div/div[2]/div[1]/ul/*/table/tbody/tr[1]/td[1]"

# 文章内容
xpath_text = "/html/body/div[2]/div/div[3]/div/div[2]/div//text()"
...
def driverInit():
    ...
    for indexl in range(1, 105):
        ...
        li_time = tree.xpath(xpath_a_text)
        ...
        for lit in li_time:
            li = lit.xpath(".//text()")
            li = str(li).replace(" ", "").replace(",", "").replace("\'", "").replace("[", "").replace("]", "").replace("\\t", "").replace("/", "")
            print("标题" + li)
            print("标题" + li)
            # 将标题压入列表
            txt_name.append(li)
    ...
    for (index, context) in enumerate(href_list):
        print("正在访问第" + "["+str(index+1) +"/" + str(len(href_list)) +"]"+ "篇文章\n")
        driver.get(context)
        ...
        # 判断文件夹是否存在,没有则创建
        path = "./12个市规划" + "/邢台市规划/" +time_list[index][5:9] + "/" + time_list[index][10:12] +"/" +txt_name[index]
        ...
        #     img_url_name = img_url_name[0:40]
        #     headers = {
