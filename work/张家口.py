...
guanwang = "http://www.zjk.gov.cn/search.jsp?pn="
guanwang2 = "&keywords=%25E8%25A7%2584%25E5%2588%2592&classId=&pid="
...
# a标签
xpath_a = "/html/body/div[2]/div/div[4]/ul/*/a"

# a的文本
xpath_a_text = "/html/body/div[5]/div[1]/div[2]/div[1]/ul/*/a[2]"

# 时间
xpath_time = "/html/body/div[2]/div/div[4]/ul/*/table/tbody/tr/td"


# 文章内容
xpath_text = "/html/body/div[3]/div/div[2]/div[2]/div[1]//text()"
...
def driverInit():
    ...
    for (index, context) in enumerate(href_list):
        ...
        # 判断文件夹是否存在,没有则创建
        path = "./12个市规划" + "/张家口市规划/" +time_list[index][0:4] + "/" + time_list[index][5:7]
