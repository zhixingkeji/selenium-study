...
# a标签
xpath_a = "/html/body/div[1]/table/tbody/tr/td/div/div[2]/div/table/tbody/tr/td[2]/ol/*/div[1]/a"
...
guanwang= "https://www.hd.gov.cn/was5/web/search?page="
guanwang2 = "&channelid=258715&searchword=%E8%A7%84%E5%88%92&keyword=%E8%A7%84%E5%88%92&perpage=10&outlinepage=10&searchscope=&timescope=&timescopecolumn=&orderby=&andsen=&total=&orsen=&exclude="
...
# 时间
xpath_time = "/html/body/div[6]/div[1]/div[2]/p[2]//text()"


# 文章内容
xpath_text = "/html/body/div[6]/div[2]//text()"
...
def driverInit():
    ...
    for (index, context) in enumerate(href_list):
        try:
            ...
            ti = tree.xpath(xpath_time)
            ti = str(ti)
            print("时间" + ti)
            # 判断文件夹是否存在,没有则创建
            path = "./12个市规划" + "/邯郸市规划/" + ti[11:15] + "/" + ti[16:18]
