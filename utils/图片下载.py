...
def request_download(IMAGE_URL):
    ...
    url_a = requests.get(url=IMAGE_URL, headers=headers).content
...
if __name__ == "__main__":
    request_download("http://www.beijing.gov.cn/gongkai/guihua/wngh/sjzdzxgh/202109/W020210908555141952329.png")
